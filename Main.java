...
public class Main {
    ...
    private static void cadastrarEvento(Scanner scanner, EventoGerenciar clienteGerenciador) {
        ...
        LocalDateTime dataFormatada = LocalDateTime.parse(data, parser);
        ...
        if (tipo == 1) {
            ...
            novaExp = new Show(titulo, "Show Musical", dataFormatada, 100, preco, artista);
        } else if (tipo == 2) {
            System.out.print("Materiais: ");
            String mat = scanner.nextLine();
            novaExp = new Workshop(titulo, "Workshop Prático", dataFormatada, 30, preco, mat);
        } else if (tipo == 3) {
            System.out.print("Ponto de Encontro: ");
            String ponto = scanner.nextLine();
            System.out.print("Guia: ");
            String guia = scanner.nextLine();
            novaExp = new PasseioTuristico(titulo, "Passeio Turístico", dataFormatada, 20, preco, ponto, guia);
        }
