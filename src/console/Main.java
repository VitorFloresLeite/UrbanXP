...
public class Main {
    ...
    private static void editarStatusIngresso(IngressoGerenciar gerenciador, Scanner scanner) {
        ...
        int opcaoStatus = lerInteiro(scanner, "Novo status: ");

        switch (opcaoStatus) {
            case 1 -> ingressoSelecionado.setStatus(IngressoStatus.PAGO);
            case 2 -> ingressoSelecionado.setStatus(IngressoStatus.RESERVADO);
            case 3 -> ingressoSelecionado.setStatus(IngressoStatus.CANCELADO);
